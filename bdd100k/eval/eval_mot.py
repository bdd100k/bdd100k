...
def acc_single_video(gts: List[DictAny],
    ...
    for gt, result in zip(gts, results):
        ...
        for i in range(num_classes):
            ...
            pred_bboxes_c, pred_ids_c = pred_bboxes[pred_inds], pred_ids[
                pred_inds]
...
def eval_mot(gts: List[List[DictAny]],
    ...
    accs = pool.starmap(
        acc_single_video,
        zip(gts, results, [iou_thr for _ in range(len(gts))],
