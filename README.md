...
`bdd100k/labels` contains two json files based on [our label format](doc/format.md) for training and validation sets. [`bdd100k/vis/labels.py`](bdd100k/vis/labels.py) provides examples to parse and visualize the labels.
